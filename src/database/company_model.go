...
type Company struct {
	...
	Latitude       sql.NullFloat64 `json:"latitude"`                         // https://fakerjs.dev/api/address.html#latitude
	Longitude      sql.NullFloat64 `json:"longitude"`                        // https://fakerjs.dev/api/address.html#longitude

	Users   []*User `gorm:"many2many:users_companies"`
